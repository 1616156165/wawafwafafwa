...
exports.run = async(client, message, args) => {
    ...
    let enaltyetkiliroles = message.guild.roles.cache.get(ayar.enaltyetkiliroles)
    let yetkililer = message.guild.members.cache.filter(s => s.roles.highest.position >= enaltyetkiliroles.position && !s.user.bot)
