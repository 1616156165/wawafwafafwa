...
exports.run = async(client, message, args) => {
    ...
    let müzik = message.guild.members.cache.filter(x => x.voice.channel).filter(x => x.voice.channel.parentID === ayar.müzikID).size
...
Müzik kanallarda **${müzik}** üye bulunmakta.
